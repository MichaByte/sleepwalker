...
function gameEvent(eventNumber, input) {
  if (eventNumber == 1) {
    ...
    newDialog(
      "assets/img/oldmanneighbor.png",
        "<br>Old Man Neighbour",
      "I believe you went over that way afterward, I was tired and not paying very much attention though. You can go check it out, but I expect you to come back and pay me later! OH by the way I think you dropped your key at my house when you were here"
    ...
    if (input == 1) {
      ...
      newDialog("assets/img/femaleneighbor.png","House Resident:", "Who are you, and what do you want?");
      newLine(
    ...
    if (input == 1) {
      ...
      newDialog(
        "assets/img/femaleneighbor.png","<br>House Resident:", 
