...
function bathroom() {
  if (!rooms.bathroom.clean) {
    newLine(
      'As you walk into the bathroom, you notice that your toiletries are spilled all over the floor, and the paintings that were once on your wall are on the floor. <br>You quickly tidy up and wipe down the surfaces.<br> Where would you like to investigate next?',
      "",
